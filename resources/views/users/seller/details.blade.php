    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-lg-2 text-lg-center">
                        <div class="bg-body d-flex align-items-center justify-content-center rounded py-4">
                            <img src="/images/seller/zara.svg" alt="" class="avatar-xxl flex-shrink-0">
                        </div>
                        <div class="mt-3">
                            <a href="#!" class="btn btn-primary w-100">View Stock Detail</a>
                        </div>
                    </div>
                    <div class="col-lg-3 border-end">
                        <div class="">
                            <h4 class="mb-1"> ZARA International</h4>
                            <p class="mb-1">(Most Selling Fashion Brand)</p>
                            <a href="#!" class="link-primary fs-16 fw-medium">www.alien-spark-crm.com</a>
                            <div class="d-flex align-items-center justify-content-satrt gap-2 mt-2 mb-1">
                                ...
                                <p class="fw-medium mb-0 text-dark fs-15">4.5/5 <span class="fs-13">(+23.3K Review)</span></p>
                            </div>
                            <div class="mt-2">
                    ...
                    <div class="col-lg-7">
                        <div class="ps-lg-4">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                <p class="mb-0 fs-15 fw-medium text-dark">Man's Wares</p>
                                <div>
                                    <p class="mb-0 fs-15 fw-medium text-dark">$123k <span class="ms-1"><iconify-icon icon="solar:course-up-outline" class="text-success"></iconify-icon></span></p>
                                </div>
                            </div>
                            <div class="progress progress-soft progress-md">
                                <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" role="progressbar" style="width: 70%" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                <p class="mb-0 fs-15 fw-medium text-dark">Woman's Wares</p>
                                <div>
                                    <p class="mb-0 fs-15 fw-medium text-dark">$233k <span class="ms-1"><iconify-icon icon="solar:course-up-outline" class="text-success"></iconify-icon></span></p>
                                </div>
                            </div>
                            <div class="progress progress-soft progress-md">
                                <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" style="width: 90%" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                <p class="mb-0 fs-15 fw-medium text-dark">Kid's Wares</p>
                                <div>
                                    <p class="mb-0 fs-15 fw-medium text-dark">$110k <span class="ms-1"><iconify-icon icon="solar:course-up-outline" class="text-success"></iconify-icon></span></p>
                                </div>
                            </div>
                            <div class="progress progress-soft progress-md">
                                <div class="progress-bar bg-warning progress-bar-striped progress-bar-animated" role="progressbar" style="width: 60%" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                                <p class="mb-0 fs-15 fw-medium text-dark">Foot Wares</p>
                                <div>
                                    <p class="mb-0 fs-15 fw-medium text-dark">$51k <span class="ms-1"><iconify-icon icon="solar:course-down-outline" class="text-danger"></iconify-icon></span></p>
                                </div>
                            </div>
                            <div class="progress progress-soft progress-md">
                                <div class="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style="width: 40%" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <h4 class="card-title mt-3 mb-2">Our Story :</h4>
                <p>At ZARA, we believe that fashion is more than just clothing—it's an expression of individuality and a celebration of diversity. Founded in 2003, our journey began with a simple yet powerful vision: to create high-quality, stylish, and comfortable apparel that resonates with people from all walks of life.</p>

                <h4 class="card-title my-2">Our Mission :</h4>
                <p>Our mission is to redefine fashion by merging timeless elegance with contemporary design. We strive to offer clothing that not only looks good but also feels good, making everyday wear an enjoyable experience. At the heart of our brand is a commitment to quality, sustainability, and customer satisfaction.</p>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        <h3 class="d-flex align-items-center gap-2">$5,563.786 <span class="badge text-success bg-success-subtle px-2 py-1 fs-12"><i class="bx bx-up-arrow-alt"></i>4.53%</span></h3>
                        <p class="mb-0 text-muted">Gained <span class="text-success">$378.56</span> This Month !</p>
                    </div>
                ...
                <div class="apex-charts" id="sales_analytic_seller"></div>
            </div>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body">
                <h4 class="mb-0 text-dark fw-medium">Company Reviews</h4>
                <div class="p-2 d-flex gap-3 bg-light align-items-center justify-content-center mt-3 rounded">
                    ...
                    <p class="mb-0 text-dark fw-medium fs-16">4.5 Out of 5</p>
                </div>
                <p class="text-primary mt-2 fw-medium">Based on +23.5k Review</p>
                ...
                <div class="my-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="progress flex-grow-1" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 10px">
                            <div class="progress-bar bg-warning rounded" style="width: 80%"></div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-3 my-3">
                        <h5 class="mb-0 flex-shrink-0">4 star :</h5>
                        <div class="progress flex-grow-1" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 10px">
                            <div class="progress-bar bg-warning rounded" style="width: 50%"></div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-3 my-3">
                ...
                <a href="#!" class="text-primary mt-2 fw-medium">How do we calculate ratings ?</a>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="d-flex card-header justify-content-between align-items-center border-0 pb-1">
                <div>
                    <h4 class="card-title">Latest Added Product</h4>
                </div>
                <div class="dropdown">
                    ...
                    <table class="table align-middle mb-0 table-hover table-centered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0 mt-1 fs-13"><span>Variants : </span> 4</p>
                                        </div>
                                    </div>
                                ...
                                <td> Fashion</td>
                                <td>08/05/2023</td>
                                <td> <span class="badge p-1 bg-success-subtle text-success fs-12 me-1"><i class="bx bx-check-double align-text-top fs-14 me-1"></i> Published</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0 mt-1 fs-13"><span>Variants : </span> 2</p>
                                        </div>
                                    </div>
                                ...
                                <td> <span class="badge p-1 bg-light text-dark fs-12 me-1"><i class="bx bxs-circle align-middle fs-10 me-1"></i> Pending</span></td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="form-check">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0 mt-1 fs-13"><span>Variants : </span> 5 </p>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0 mt-1 fs-13"><span>Variants : </span> 3 </p>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0 mt-1 fs-13"><span>Variants : </span> 6</p>
                                        </div>
                                    </div>
                                ...
                                <td> Fashion</td>
                                <td>23/05/2023</td>
                                <td> <span class="badge p-1 bg-danger-subtle text-danger fs-12 me-1"><i class="bx bx-time-five align-text-top fs-14 me-1"></i> Draft</span></td>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-2">
                        <div class="avatar flex-shrink-0">
                            <span class="avatar-title bg-dark-subtle text-white fw-bold rounded fs-4">
                                1
                            </span>
                        </div>
                        <div class="d-block">
                            <h4 class="text-white fw-medium mb-0">Accounting Revenue</h4>
                        </div>
                        <div class="ms-auto">
                            <div class="dropdown">
                    ...
                    <h3 class="mt-4 text-warning fw-semibold">$5,324,000</h3>
                    <p class="mb-0 text-white-50"> Accounting revenue refers to the income earned by a company</p>
                    <h5 class="text-white-50 mb-0 mt-2"><span class="text-white">+870</span> Customers</h5>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            <h5 class="card-title mb-0 text-dark fw-medium">Orders</h5>
                            <div class="avatar-md bg-light bg-opacity-50 rounded mx-auto my-3">
                                <iconify-icon icon="solar:cart-4-broken" class="fs-32 text-primary avatar-title"></iconify-icon>
                            </div>
                            <h4 class="text-dark fw-medium">458</h4>

                            <p class="text-muted">60% Target</p>

                            <div class="progress mt-2" style="height: 10px;">
                                <div class="progress-bar progress-bar  progress-bar-striped progress-bar-animated bg-primary" role="progressbar" style="width: 60%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="70">
                                </div>
